...
const EmailTemplatesPage: React.FC = () => {
  ...
  const templates: Template[] = [
    ...
    },
    {
      id: 'quote-sent',
      name: 'Quote Sent',
      description: 'Quote available notification with approval and payment options',
      category: 'Quote',
      preview: '💰'
    },
    {
      ...
      description: 'Customer account statement with aging and envelope window',
      category: 'Accounting',
      preview: '📄'
    },
    {
          ...
          <div className="templates-grid-large">
            {filteredTemplates.map((template) => (
              <div
                ...
                onClick={() => navigate(`/${template.id}-template`)}
              >
